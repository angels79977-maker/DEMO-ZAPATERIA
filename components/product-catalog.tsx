...
interface ProductCatalogProps {
  searchQuery: string
  activeNavCategory: Category | 'Sale' | null
}
...
export function ProductCatalog({ searchQuery, activeNavCategory }: ProductCatalogProps) {
  ...
  return (
    <section id="catalog" className="mx-auto max-w-7xl px-4 py-10 lg:px-8">
      <div className="flex items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-black tracking-tight md:text-3xl">Catalog</h2>
      ...
      <div className="mt-6 flex gap-8">
        <aside className="hidden w-56 shrink-0 lg:block" aria-label="Filter products">
